...
All interaction system enums are isolated in a single header. Nearly every file in the system includes this header. Isolating enums prevents cascade recompiles when a value is added or renamed.
