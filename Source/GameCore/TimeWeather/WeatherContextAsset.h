...
#include "WeatherContextAsset.generated.h"

class USeasonDefinition;
class UWeatherSequence;

/**
 * Full weather configuration for one context (global world or a region).
 * Referenced by UTimeWeatherConfig::GlobalContext and by region actors
 * via IWeatherContextProvider::GetWeatherContext().
 */
