...
// Game systems bind here on the interactable actor (e.g. ore node, shop NPC, chest)
// to react without needing a reference to the player pawn's manager component.
