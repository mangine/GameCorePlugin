...
#include "HISMProxyConfig.generated.h"

/**
 * UHISMProxyConfig
 *
 * UDataAsset holding proximity and timing configuration for one HISM proxy setup.
 * Referenced by each FHISMProxyInstanceType entry on AHISMProxyHostActor.
 * Multiple instance types can share the same config asset when their proximity
...
#if WITH_EDITOR
inline EDataValidationResult UHISMProxyConfig::IsDataValid(
